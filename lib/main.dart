              ...
              Padding(
                ...
                child: Center(
                  child: Container(
                      ...
                      ),child: Image(image: const AssetImage("assets/images/logo.png"),height:SizeConfig.screenHeight*0.1),
     ...
     crossAxisAlignment: CrossAxisAlignment.center,
      children: [
        Padding(
          ...
          child: Image(image: const AssetImage("assets/images/group.png"),height:parentHeight*0.2,),
        ),
        ...
        SizedBox(height: 40),
        Padding(
          padding:  EdgeInsets.only(left: parentWidth*0.09,right: parentWidth*0.09),
          child: Text("Upgrade your Product with new products after 15 Days of use for free",
              style: TextStyle(
                color: Colors.black,
