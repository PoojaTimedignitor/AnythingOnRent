...
/*  Future<void> _fetchBackendData() async {
    // Simulate API call (e.g., using http package)
    await Future.delayed(Duration(seconds: 2));

    // Dummy data, replace this with the actual backend response
    final fetchedData = {
      'Suggestion 1': ['Sub-item 1.1', 'Sub-item 1.2', 'Sub-item 1.3'],
      'Suggestion 2': ['Sub-item 2.1', 'Sub-item 2.2'],
      'Suggestion 3': ['Sub-item 3.1', 'Sub-item 3.2', 'Sub-item 3.3'],
    };

    setState(() {
      filteredSubCat = fetchedData; // Update the state with the fetched data
    });
  }*/
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      //
                                        //
                                      //
                                      //  onTap: () => _showMainSuggestionDialog(context),
